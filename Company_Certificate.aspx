<%@ Page Title="" Language="C#" MasterPageFile="~/Yachts.Master" AutoEventWireup="true" CodeBehind="Company_Certificate.aspx.cs" Inherits="yatch_project.WebForm1" %>
        ...
        <div class="left">
          <div class="left1">
            ...
            <ul>
              ...
              <li><a href='Company_Certificate.aspx' target='_self'>Certificat</a></li>
            </ul>
          </div>
        </div>
        <!--------------------------------左邊選單結束---------------------------------------------------->
        <!--------------------------------右邊選單開始---------------------------------------------------->
        <div id="crumb"><a href="index.html">Home</a> >> <a href="#">Company </a> >> <a href="#"><span class="on1">Certificat</span></a></div>
        <div class="right">
          <div class="right1">
            ...
            <div class="box3">
              ...
              <div class="pit">
                <ul>
                  <li>
                    <p><img src="images/certificat001.jpg" alt="Tayana " /></p>
                  </li>
                  <li>
                    <p><img src="images/certificat002.jpg" alt="Tayana " /></p>
                  </li>
                  <li>
                    <p><img src="images/certificat003.jpg" alt="Tayana " /></p>
                  </li>
                  <li>
                    <p><img src="images/certificat004.jpg" alt="Tayana " /></p>
                  </li>
                  <li>
                    <p><img src="images/certificat005.jpg" alt="Tayana " /></p>
                  </li>
                  <li>
                    <p><img src="images/certificat006.jpg" alt="Tayana " /></p>
                  </li>
                  <li>
                    <p><img src="images/certificat007.jpg" alt="Tayana " width="319" height="234" /></p>
                  </li>
                  <li>
                    <p><img src="images/certificat008.jpg" alt="Tayana " width="319" height="234" /></p>
                  </li>
                </ul>
              </div>
            </div>
