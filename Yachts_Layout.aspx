<%@ Page Title="" Language="C#" MasterPageFile="~/Yachts.Master" AutoEventWireup="true" CodeBehind="Yachts_Layout.aspx.cs" Inherits="yatch_project.Yachts_Layout" %>
      ...
      <div class="conbg">
        ...
        <div class="right">
            ...
            <div class="box6">
             ...
             <asp:Label ID="CKEditorControl2" runat="server" Text="Label"></asp:Label>
            </div>
            <div class="clear">
            </div>
            <!--------------------------------內容結束------------------------------------------------------>
